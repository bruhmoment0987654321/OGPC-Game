function GenerateLevel(){
	...
	for(var _x = 0; _x < room_width;_x+= Gridsize){
		//top border
		instance_create_layer(-Gridsize, 0, "Walls",Obj_solid);	
		instance_create_layer(-Gridsize, -Gridsize, "Walls",Obj_solid);
		
		instance_create_layer(room_width, 0, "Walls",Obj_solid);
		instance_create_layer(room_width, -Gridsize, "Walls",Obj_solid);
		
		instance_create_layer(_x, 0, "Walls",Obj_solid);	
		instance_create_layer(_x, -Gridsize, "Walls",Obj_solid);	
		
		//bottom border
		instance_create_layer(-Gridsize,room_height,"Walls",Obj_solid);
		instance_create_layer(-Gridsize,room_height-Gridsize,"Walls",Obj_solid);
		
		instance_create_layer(room_width,room_height,"Walls",Obj_solid);
		instance_create_layer(room_width,room_height-Gridsize,"Walls",Obj_solid);
		...
		instance_create_layer(_x,room_height,"Walls",Obj_solid);
	}
	for(var _y = Gridsize; _y < room_height-Gridsize;_y+= Gridsize){
		...
		instance_create_layer(room_width,_y,"Walls",Obj_solid);
	}
