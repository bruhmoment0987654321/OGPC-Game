...
with(tile)
{
    ...
    if (position_meeting(x,y - img_height, Obj_solid))  u = 1;
    if (position_meeting(x + img_width,y,Obj_solid))  r = 2;
    if (position_meeting(x,y + img_height, Obj_solid))  d = 4;
    if (position_meeting(x - img_width,y,Obj_solid))  l = 8;
    
    // Check corner existence
    if (position_meeting(x - img_height, y - img_width, Obj_solid))  ul = 1;
    if (position_meeting(x + img_height, y - img_width, Obj_solid))  ur = 2;
    if (position_meeting(x + img_height, y + img_width, Obj_solid))  dr = 4;
    if (position_meeting(x - img_height, y + img_width, Obj_solid))  dl = 8;
