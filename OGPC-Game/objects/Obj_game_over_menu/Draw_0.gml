...
//center menu
x = (camera_get_view_x(view_camera[0]) + camera_get_view_width(view_camera[0])/2-width/2)+x_offset;
y = (camera_get_view_y(view_camera[0]) + camera_get_view_width(view_camera[0])/2-height)+y_offset;
